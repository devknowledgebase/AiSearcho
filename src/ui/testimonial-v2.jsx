...
export default function App() {
  return (
    <div className="dark w-screen min-h-screen flex flex-col justify-center relative selection:bg-primary selection:text-white cursor-default" style={{ backgroundColor: '#030101' }}>
      <TestimonialsSection />
    </div>
  );
}